...
**各子集的熵**
- **无房组熵：**
  $$H(D_1) = -\frac{5}{8}\log_2\frac{5}{8} - \frac{3}{8}\log_2\frac{3}{8} = 0.954$$
- **有房组熵：**
...
- **计算：**
  ...
  \begin{aligned}
  H(D\mid\text{有房})
  &= \frac{8}{15} \times 0.954 + \frac{7}{15} \times 0.592 \\[4pt]
  &= 0.509 + 0.276 \\[4pt]
  &= 0.785
  \end{aligned}
  $$
...
**信息增益**
- **计算：**
  $$\text{Gain}(\text{有房}) = 0.971 - 0.785 = 0.186$$

**特征熵（分裂信息）**

- **计算：**
  $$H_A(\text{有房}) = -\frac{8}{15}\log_2\frac{8}{15} - \frac{7}{15}\log_2\frac{7}{15} = 0.997$$

**信息增益比**
- **计算：**
  $$\text{Gain\_ratio}(\text{有房}) = \frac{0.186}{0.997} = 0.187$$
...
**结论：有工作的信息增益比最大(0.353)，应优先选择该特征进行分裂。**
