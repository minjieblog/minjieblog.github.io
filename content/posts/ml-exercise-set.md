...
tags: ["机器学习", "数学推导", "算法"] 
math: true
summary: "系统梳理机器学习核心算法的数学推导，涵盖线性回归、逻辑回归、SVM、决策树、XGBoost等经典方法，适合研究生课程学习和算法原理深入理解。" description: "本习题集包含16道经典机器学习问题的完整数学推导，从梯度下降、交叉熵损失、最大似然估计，到核方法、支持向量机对偶问题、信息增益比|
