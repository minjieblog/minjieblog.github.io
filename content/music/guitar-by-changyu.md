---
title: 常俞吉他｜学习笔记
date: 2026-01-30T19:01:57+08:00
draft: true
tags:
  - 吉他
  - 音乐学习
categories:
  - 音乐
summary: 常俞吉他课程100节课的系统学习与练习记录。
description: 记录常俞吉他课程的完整学习过程，涵盖基础概念、指法练习、练琴要点与个人理解，用于长期复盘与持续进阶的吉他学习笔记。
comments: true
hidden: true
"":
---
...
- 首先右手和大腿控制琴**让琴保持固定**，这样左手就不会让琴跑偏
- **左手心空**（像握鸡蛋）展开上琴
- 拇指放在琴颈后方**中央的位置，**不要太靠上或太靠下，尽量保持平行于中指，左侧不宜超过食指
- 指尖**垂直于**琴弦，不要用力过度，按弦**靠近品柱**（*可以更小的力气发音*），但不要按在品柱上

### 右手拨弦方法

![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAOjaY_T1qdHf2oSxLZ3H12ifSBfOeEAAm8RaxvqcnlUMsaXCq7ohysBAAMCAAN3AAM6BA.png)

- **发力方式**：通过头部发力，而不是指尖发力的方式
- **练习**：开节拍器，至多一个拍子四个音的方式 

### 右手拨片方法

- **握法**：食指弯曲，漏出1/3的样子即可，配合大拇指固定住拨片
- **练习**：n（上）   v（下）   n（上）   v（下）
...
![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAOkaZ_GQlfM94yskONQjRRLGWADjZUAAvsNaxtBNQFV9p8mNOXQ_7gBAAMCAAN3AAM6BA.png)

- **练习有效性**：手指立起来，无杂音（其他的弦不受影响）
- **轮指方式**：从一品开始，循环一轮，***开节拍器***

#### 2.变奏爬格子1434，1324，4321

#### 3.跨品练习

![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAOlaZ_ZGkgllnY9TZHnu9mn-if5u_YAAjIOaxtBNQFV3c3ozZgKk9UBAAMCAAN3AAM6BA.png)

## 2.乐理

### 音节命名

![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAOmaaEERH4K_25FTOuSbfmwiM0NzaEAApgNaxtBNQlV8Wxq8BE80IcBAAMCAAN3AAM6BA.png)

### 十二平均律

![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAOnaaEEcRV7Z7BGUuXsjQqwfMkhUi8AApkNaxtBNQlV5EtiI4p57kIBAAMCAAN3AAM6BA.png)
...
#### 3.音阶练习-la型
![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAPpajikVGwT89zmQ9qgMSifuT6_TrYAAsAPaxt1_8hVg2nYg_aZgWABAAMCAAN5AAM8BA.png)
#### 4. 音阶练习-ti型
![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAPpajikVGwT89zmQ9qgMSifuT6_TrYAAsAPaxt1_8hVg2nYg_aZgWABAAMCAAN5AAM8BA.png)
#### 5. 音阶练习-do型
![](https://telegraph-image-43w.pages.dev/file/AgACAgUAAyEGAATTNkFKAAPqajikyN6WxAOQ1fIaJpBTAAFXBOmjAALCD2sbdf_IVXywjFI7lqwCAQADAgADeQADPAQ.png)
#### 6. 音阶练习-re型
